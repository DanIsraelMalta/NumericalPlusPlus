    ...
    **/
    template<typename T> class Quaternion {
        ...
        public:
            ...
            // rotate a set of points using a (NORMALIZED) quaternion
            friend void RotatePointUsingQuaternion(const Quaternion<T>& xi_quat, VectorN<T, 3>& xio_point) noexcept {
            ...
            template<typename...Ts> friend void RotatePointUsingQuaternion(const Quaternion<T>& xi_quat, VectorN<T, 3>& xio_point, Ts...ts) noexcept {
                RotatePointUsingQuaternion(xi_quat, xio_point);
                RotatePointUsingQuaternion(std::forward<Ts>(ts)...);
            }
