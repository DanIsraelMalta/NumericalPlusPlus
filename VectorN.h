...
namespace Numeric {
	...
	**/
	...
	public:
		constexpr VectorN& operator += (const T xi_value) {
			static_for<0, N>([&](std::size_t i) {
				m_data[i] += xi_value;
			});
		...
		constexpr VectorN& operator += (const VectorN& xi_vector) {
		...
		constexpr VectorN& operator += (VectorN&& xi_vector) {
			assert(N == xi_vector.size());
	...
	**/
	...
	// binary plus
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> operator + (const VectorN<T, N>& xi_lhs, const T& xi_rhs) {
		VectorN<T, N> xo_vec(xi_lhs);
		xo_vec += xi_rhs;
		return xo_vec;
	}

	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& operator + (VectorN<T, N>&& xi_lhs, const T& xi_rhs) {
		xi_lhs += xi_rhs;
		return xi_lhs;
	}

	template<typename T, std::size_t N> constexpr  inline VectorN<T, N> operator + (const T& xi_lhs, const VectorN<T, N>& xi_rhs) {
		VectorN<T, N> xo_vec(xi_rhs);
		xo_vec += xi_lhs;
		return xo_vec;
	}

	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& operator + (const T& xi_lhs, VectorN<T, N>&& xi_rhs) {
		xi_rhs += xi_lhs;
		return xi_rhs;
	}

	template<typename T, std::size_t N> constexpr inline VectorN<T, N> operator + (const VectorN<T, N>& xi_lhs, const VectorN<T, N>& xi_rhs) {
		VectorN<T, N> xo_vec(xi_lhs);
		xo_vec += xi_rhs;
		return xo_vec;
	}

	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& operator + (VectorN<T, N>&& xi_lhs, const VectorN<T, N>& xi_rhs) {
		xi_lhs += xi_rhs;
		return xi_lhs;
	}

	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& operator + (const VectorN<T, N>& xi_lhs, VectorN<T, N>&& xi_rhs) {
		xi_rhs += xi_lhs;
		return xi_rhs;
	}

	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& operator + (VectorN<T, N>&& xi_lhs, VectorN<T, N>&& xi_rhs) {
		xi_lhs += xi_rhs;
		return xi_lhs;
	}
	...
	**/
	...
	template<typename T, std::size_t N> constexpr inline bool operator == (const VectorN<T, N>& xi_lhs, const VectorN<T, N>& xi_rhs) {
		bool xo_equal{ false };

		for (std::size_t i{}; (i < N) && !xo_equal; ++i) {
			xo_equal = xi_lhs[i] == xi_rhs[i];
		}
	...
	template<typename T, std::size_t N> constexpr inline bool operator < (const VectorN<T, N>& xi_lhs, const VectorN<T, N>& xi_rhs) {
		...
		for (std::size_t i{}; (i < N) && !xo_small; ++i) {
			xo_small = xi_lhs[i] < xi_rhs[i];
		}
	...
	**/
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> abs(const VectorN<T, N>& xi_value) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& abs(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> ceil(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& ceil(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> floor(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& floor(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> sqrt(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& sqrt(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> pow(const VectorN<T, N>& xi_base, const T xi_power) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& pow(VectorN<T, N>&& xi_base, const T xi_power) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> sin(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& sin(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> cos(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& cos(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> tan(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& tan(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> asin(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& asin(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N> acos(const VectorN<T, N>& xi_value) {
		VectorN<T, N> xo_return(xi_value);
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& acos(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
	...
	template<typename T, std::size_t N> constexpr inline VectorN<T, N>& atan(VectorN<T, N>&& xi_value) {
		static_for<0, N>([&](std::size_t i) {
